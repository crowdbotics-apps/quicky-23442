"""quicky_23442 URL Configuration
...
admin.site.site_header = "quicky"
admin.site.site_title = "quicky Admin Portal"
admin.site.index_title = "quicky Admin"

# swagger
api_info = openapi.Info(
    title="quicky API",
    default_version="v1",
    description="API documentation for quicky App",
)
